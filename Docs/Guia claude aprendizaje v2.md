...
- $200+ USD invertidos en créditos
- 17 errores críticos documentados
- 1+ semana de iteraciones continuas
...
### 💰 ANÁLISIS DE COSTOS REALES - SESIÓN DE HOY
...
**Lo que pasó:**
```python
# Claude generó fórmulas en ESPAÑOL:
...
**Lo que pasó:**
```python
# PARTE 1 (que Claude dio primero):
VERSION = "4.0"
TC_ACTUAL = 540
...
# PARTE 2 (que Claude dio después):
...
**Costo real:** ~$30 en créditos + 1 hora + tuviste que pedir el código 3 veces
...
# Claude dio: 6 hojas (versión "simplificada" sin avisar)
```
...
1. NUNCA simplificar sin permiso explícito del usuario
2. Si hay duda sobre complejidad, PREGUNTAR antes de implementar
3. Dar EXACTAMENTE lo que se pidió, no "versiones rápidas"
...
- [ ] Documentar idioma confirmado: _______________
...
- [ ] ¿Las fórmulas están en el idioma correcto?
  - Idioma Excel: _______________
  - Idioma fórmulas: _______________
...
- [ ] ¿Tengo los saldos REALES de tarjetas?
  - BAC Visa: ₡_______________
  - BCR Mastercard: ₡_______________
  - Credomatic Platinum: $_______________
  - Credomatic Gold: ₡_______________
...
- [ ] Idioma para nombres de hojas: _______________
- [ ] Idioma para nombres de columnas: _______________
- [ ] Idioma para fórmulas: _______________
- [ ] Idioma para comentarios de ayuda: _______________
...
## 📚 TABLA MAESTRA DE ERRORES (13 Total)
...
- Claude dio: 6 hojas (versión "simplificada")
...
1. Dar las 14 hojas completas desde inicio
2. Si hay duda, PREGUNTAR antes
3. No asumir que "más simple es mejor"
...
- ❌ Primer impulso: "Cambiar directamente el valor en Excel"
- ✅ Mejor enfoque: "Investigar por qué está mal"
...
**Problema:** Intentaste descargar archivos que Claude creó
```powershell
...
- ✅ **Iteración y Paciencia:** No abandonaste cuando hubo errores
- ✅ **Comunicación Clara:** Proveías contexto (extractos, screenshots, errores)
- ✅ **Validación:** Ejecutabas scripts y reportabas resultados
- ✅ **Flexibilidad:** Aceptaste cambios de enfoque
- ✅ **Documentación:** Pediste guías y documentación

### NUEVO - Lo que Aprendiste Esta Sesión

- ✅ NUNCA asumir (idioma Excel, requisitos, datos)
- ✅ Checklist de 5 min = $195 ahorrados
- ✅ UN archivo completo > código dividido
- ✅ Dar lo solicitado (no simplificar)
- ✅ Consistencia idioma (todo español excepto fórmulas)
- ✅ Claude Git ≠ GitHub real (usar copy/paste)
- ✅ Test pequeño primero (validar antes de escalar)
